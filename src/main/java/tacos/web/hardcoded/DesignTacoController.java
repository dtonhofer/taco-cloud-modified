...
public class DesignTacoController {
    ...
    // Constructor called by Spring at scan time

    public DesignTacoController(@NotNull PrefilledIngredientRelation ingredientRelation) {
